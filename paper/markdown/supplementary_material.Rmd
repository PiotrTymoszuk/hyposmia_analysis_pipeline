...
### Rating of olfactory dysfunction with Sniffin' Stick Identification Test

Objective olfactory dysfunction at the 100-day and 360-day follow-up in the CovILD study participants was investigated with the 16-item Sniffn' Stick Identification Test as described [@Hummel1997; @Rass2021; @Whitcroft2016; @Masala2022; @Damm2014]. 
Note that the threshold and discrimination dimensions of the Sniffin' Stick test [@Hummel1997] were not investigated. 
...
The 13 point cutoff of the identification test corresponded approximately to the 25^th^ percentile of correct answers in the identification test in healthy adult subjects of both sexes reported in two large normative studies [@Hummel2007; @Oleszkiewicz2019a]. 
...
```{r fig-hyposmia-rater100, fig.width = figur::convert(suppl$hyposmia_rater100, to = 'in')$w, fig.height = figur::convert(suppl$hyposmia_rater100, to = 'in')$h, fig.cap = "Rates of self-reported olfactory dysfunction and olfactory dysfunction in the Sniffin' Stick Identification Test at 3-month post COVID-19 follow-up in the ambulatory, moderate and severe COVID-19 subsets of the CovILD study."}

suppl$hyposmia_rater100$plot

```

__Supplementary Figure S\@ref(fig:fig-hyposmia-rater100). Rates of self-reported olfactory dysfunction and olfactory dysfunction in the Sniffin' Stick Identification Test at 3-month post COVID-19 follow-up in the ambulatory, moderate and severe COVID-19 subsets of the CovILD study.__
